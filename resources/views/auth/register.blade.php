        ...
        <div class="auth-fluid-form-box">
            <div class="align-items-center d-flex h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-2">Don't have an Agrixpress account? Create your account, it takes less than a minute</p>
                    <!-- form -->
                    <form  method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="form-group">
                            <label for="fullname">Full Name</label>
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('firstname') }}" placeholder="Enter First Name" autocomplete="name" autofocus>
